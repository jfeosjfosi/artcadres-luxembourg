...
def btn(label, href, cls="btn"):
    return f'<a class="{cls}" href="{href}">{e(label)} {ARROW}</a>'
...
<footer class="site-footer"><div class="fw">
  <div class="footer-cols">
    ...
    <div class="fcol"><h3>Nos prestations</h3><div class="flinks">
      ...
      <a href="encadrement-standard.html">Encadrement standard</a>
...
def strip(imgs, cols):
    ...
    return f'<div class="p-strip strip-{cols}">{cells}</div>'
...
def content_hero(eyebrow, heading, lead_html, image, caption, solo=False):
    if solo:
        ...
        fig = (f'<figure><div class="p-frame"><img src="{image}" alt="{e(heading)}" '
               f'loading="lazy"></div>{cap}</figure>')
    solo_cls = " p-hero-solo" if solo else ""
    return (f'<div class="p-hero{solo_cls}"><div class="p-intro">'
...
def content_story(title, paras):
    ...
    return f'<div class="p-story"><h2>{e(title)}</h2><div class="p-body">{body}</div></div>'
...
conf_strip = ["Deloitte", "Accor", "SES", "Cour grand-ducale", "Bibliothèque nationale",
              "Maison Heler", "SODIKART", "M.Chat"]
conf_cards = [("ref-deloitte", "Deloitte", "Œuvres et grand format pour ses bureaux"),
              ("ref-accor", "Accor", "Hôtels ibis Styles, Mercure & MGallery"),
              ("ref-ses", "SES", "Fournisseur sur site du groupe satellite"),
              ("ref-courducale", "Cour grand-ducale", "Plus de 200 portraits officiels"),
              ("ref-bibliotheque", "Bibliothèque nationale", "Grand format en situ"),
              ("ref-maisonheler", "Maison Heler Metz", "Le bar de l'hôtel Philippe Starck"),
              ("ref-sodikart", "SODIKART", "Maillots et pièces de collection signés"),
              ("ref-mchat", "M.Chat", "Collaboration avec l'artiste Thoma Vuille")]
conf_strip_html = "".join(f"<span>{e(n)}</span>" for n in conf_strip)
conf_cards_html = "".join(
    f'<div class="p-card"><div class="p-fr"><img src="assets/{s}.jpg" alt="{e(n)}" '
    f'loading="lazy"></div><h3>{e(n)}</h3><p>{e(l)}</p></div>' for s, n, l in conf_cards)
...
<div class="p-w">
  <div class="p-services">{svc_html}</div>
  <div class="p-story">
  ...
  <div class="p-cta"><h2>Votre devis, tout de suite</h2><p>Composez votre cadre en ligne et obtenez un prix instantané, sans engagement.</p>{btn("Ouvrir le configurateur", "configurateur.html")}</div>
</div>
</section>
<section id="conf" class="section"><div class="p-w">
<span class="p-eyebrow">Ils nous font confiance</span>
<h2 class="p-h2">Des institutions, des marques et des artistes</h2>
<div class="p-strip2">{conf_strip_html}</div>
<div class="p-grid">{conf_cards_html}</div>
</div></section>
<section id="gf" class="section"><div class="p-w">
<span class="p-eyebrow">Grands formats & pièces d'exception</span>
<div class="p-feat">
  ...
  <div class="p-imgs"><div class="p-fr"><img src="assets/gf-deloitte-1.jpg" alt="Grand format" loading="lazy"></div><div class="p-fr"><img src="assets/gf-deloitte-2.jpg" alt="Grand format" loading="lazy"></div></div>
</div>
<h3 class="p-objh">On peut tout encadrer</h3>
<div class="p-objs">{gf_objs_html}</div>
</div></section>
<section id="avis" class="section"><div class="p-w">
<span class="p-eyebrow">Avis clients</span>
<h2 class="p-h2">Ils nous ont fait confiance, ils en parlent</h2>
<div class="p-badges">
  <div class="p-badge"><span class="v">4,9/5</span><span class="s">★★★★★</span><span class="m">76 avis · Maison Neumann</span></div>
  <div class="p-badge"><span class="v">4,7/5</span><span class="s">★★★★★</span><span class="m">12 avis · Art'Cadres Luxembourg</span></div>
</div>
<div class="p-avis">{avis_cards}</div>
</div></section>'''
...
<div class="p-list">{content_list("Nos métiers réunis en un même lieu", [("Encadrement sur mesure", "Baguette, passe-partout et verre choisis pour sublimer chaque œuvre."), ("Restauration de tableaux", "Conservation et remise en valeur des pièces anciennes."), ("Dorure à la feuille", "Cadres, miroirs et objets dorés selon les techniques traditionnelles."), ("Galerie d'art", "Une collection coup de cœur, encadrée et mise en lumière.")])}</div>
{strip(["assets/histoire-mchat.jpg", "assets/histoire-atelier-1.jpg", "assets/histoire-atelier-2.jpg"], 3)}
<figure class="p-quote"><blockquote>« Chaque œuvre mérite une présentation à la hauteur de son histoire. »</blockquote><figcaption>Kathia Neumann — Art'Cadres Luxembourg</figcaption></figure>
<div class="p-note"><p>Particuliers, artistes, collectionneurs, architectes, décorateurs, entreprises et institutions bénéficient d'un accompagnement confidentiel, personnalisé et exigeant.</p></div>
<div class="p-cta">{btn("Prendre rendez-vous", "contact.html")}</div>
</div></section>'''

# ================= ENCADREMENT SUR MESURE =================
mesure_body = f'''<section class="section"><div class="p-w">
{content_hero("Sur mesure", "Encadrement sur mesure au Luxembourg", "<p>L'encadrement d'art est avant tout de l'artisanat, et il existe des centaines de possibilités différentes. L'originalité et la subtilité de l'encadrement font la différence pour la mise en valeur de vos œuvres.</p>", "assets/ac-mesure.jpg", "Encadrement sur mesure à l'atelier")}
{content_story("Mettre l'œuvre en valeur, selon votre budget", ["Notre objectif principal est la mise en valeur de l'œuvre, en tenant compte de la sensibilité de chacun, avec un budget adapté grâce à une gamme étendue de moulures tous styles, du contemporain au classique.", "Styles de nos moulures : modernes, noirs, blanc, chêne, or, wengé, gris, couleurs…"])}
<div class="p-list">{content_list("Quelques techniques du sur-mesure", [("« Marie-Louise biseautée »", "Le haut de gamme du passe-partout : elle crée une profondeur sur vos sujets, montage traditionnel et moderne à la fois."), ("« Caisse américaine »", "Le type d'encadrement le plus répandu au monde : une mise en valeur par effet de suspension, l'œuvre flotte dans le cadre."), ("« Technique de rehausse »", "Un sujet, un verre de protection, une moulure et une rehausse pour que le verre soit en suspension au-dessus du sujet.")])}</div>
<div class="p-list p-list2">{content_list("Les baguettes Nielsen — 4 univers", [("Nature", "Bois naturel, massif et placage."), ("Color", "Un monde tout en couleur : vives ou pastel, mates ou brillantes."), ("Design", "Des lignes pures, associées à des finitions sobres ou métallisées."), ("Charme", "L'univers des dorures, des patines à l'ancienne et des finitions blanchies.")])}</div>
{strip(["assets/ac-mesure-1.jpg", "assets/ac-mesure-2.jpg", "assets/ac-mesure-3.jpg"], 3)}
<div class="p-cta">{btn("Composer votre cadre en ligne", "configurateur.html")}</div>
</div></section>'''

# ================= ENCADREMENT STANDARD =================
standard_body = f'''<section class="section"><div class="p-w">
{content_hero("Cadres standards", "Les cadres Nielsen", "<p>Une qualité qui fait la différence : tous les cadres Nielsen, en aluminium et en bois, sont réalisés avec des matériaux de grande qualité.</p>", "assets/ac-standard.jpg", "Cadres Nielsen, bois et aluminium")}
<div class="p-list">{content_list("Une qualité qui fait la différence", [("Les cadres bois", "Des dorés aux couleurs vives en passant par les bois bruts : une large palette de styles."), ("Les cadres aluminium", "Simples à charger, démonter et remonter ; tournettes rivetées sur dos MDF, verre minéral 2 mm à chants polis — aucun risque de blessure."), ("Conçus par Nielsen Design", "FSC® garantit une gestion responsable des forêts. La plupart de nos cadres bois sont certifiés éco-responsables."), ("Fabriqué en Allemagne", "Nielsen, marque de référence de l'encadrement : une expertise sur le cadre, le verre et le contrecollé.")])}</div>
...
{content_hero("Restauration de tableaux", "Redonnez vie à vos œuvres d'art", "<p>Le temps laisse son empreinte : vernis jaunis, salissures, poussière, petites déchirures ou altérations peuvent ternir la beauté d'un tableau ancien.</p>", "assets/ac-dorures.jpg", "Restauration d'un tableau à l'atelier")}
{content_story("La préservation de votre patrimoine", ["Chez Art'Cadres, nous vous accompagnons dans la préservation de votre patrimoine artistique grâce à des prestations de nettoyage et de restauration réalisées avec le plus grand soin.", "Chaque œuvre est étudiée avant toute intervention afin de lui redonner son éclat tout en respectant son histoire, ses matériaux et l'intention de l'artiste. Parce qu'un tableau est bien plus qu'un objet décoratif : c'est un souvenir de famille, un héritage ou une pièce de collection qui mérite d'être préservée pour les générations futures."])}
{strip(["assets/ac-dorures-1.jpg", "assets/ac-dorures-2.jpg", "assets/ac-dorures-3.jpg", "assets/ac-dorures-4.jpg"], 4)}
<div class="p-note"><p>N'hésitez pas à nous apporter votre tableau pour un diagnostic et un devis personnalisés.</p></div>
<div class="p-cta">{btn("Demander un diagnostic", "contact.html")}</div>
</div></section>'''

# ================= PARTENAIRES =================
partenaires_items = [
    ("L'encadr'heure — Bordeaux", "20 Place Gambetta, 33000 Bordeaux · 05 56 51 08 01"),
    ("Angles Var — La Garde / Toulon", "1215 Chemin des Plantades, 83130 La Garde · 06 95 63 40 41"),
    ("Les cadres de Sophie — Tassin", "2 Place Pierre Vauboin, 69160 Tassin-la-Demi-Lune · 04 72 09 13 66"),
    ("Art et Cadres — Toulouse", "Honoré-Serres · Montaudran · Castanet-Tolosan"),
    ("Une histoire de cadre — Mulhouse", "25 Place de la Réunion, 68100 Mulhouse · 03 89 56 23 25"),
    ("Cadre Roussin — Paris", "23 Rue de l'Amiral Roussin, 75015 Paris · 01 45 66 92 51"),
    ("L'encadreur aux cadres — Caen", "2 Rue Neuve Saint-Jean, 14000 Caen · 02 31 24 63 57"),
    ("Claude Samuel — Paris", "69 Avenue Daumesnil, 75012 Paris · 01 53 17 01 11"),
    ("Le cadre passe-partout — Reims", "135 Rue de Vesle, 51100 Reims · 03 10 16 18 49"),
    ("Misterblad — Clichy", "1 Rue Leroy, 92110 Clichy · 01 81 93 18 86"),
    ("Le Chat Rouge — Pau", "11 Rue Léon Daran, 64000 Pau · 05 59 27 18 90"),
]
partenaires_body = f'''<section class="section"><div class="p-w">
{content_hero("Partenaires & fournisseurs", "Nos partenaires et fournisseurs", "<p>Découvrez les maisons avec lesquelles nous travaillons, et les encadreurs qui nous recommandent.</p>", "", "", solo=True)}
{content_story("Nielsen Design", ["Fort d'une expérience de plus de 30 ans dans le monde de l'encadrement, Nielsen réunit une équipe de passionnés qui travaille chaque jour à proposer des produits pour rendre votre intérieur aussi parfait que possible."])}
<div class="p-list">{content_list("Ils nous recommandent", partenaires_items)}</div>
<div class="p-cta">{btn("Visiter le site Nielsen", "https://www.nielsen-design.com/")}</div>
</div></section>'''

# ================= GALERIE =================
gal_cells = "".join(
    f'<figure class="g-cell"><div class="g-frame"><img src="assets/gal-{i:02d}.jpg" '
    f'alt="Œuvre encadrée Art\'Cadres" loading="lazy"></div></figure>' for i in range(1, 19))
...
<div class="g-lead"><p>Passionnés depuis plus de 30 ans, nous avons construit notre espace galerie autour d'œuvres choisies, encadrées et mises en lumière avec le même soin que celui porté à vos objets.</p></div>
<div class="g-grid">{gal_cells}</div>
<div class="g-cta">{btn("Prendre rendez-vous", "contact.html")}</div>
</div></section>'''
...
<div class="c-lead"><p>Votre artisan encadreur vous accueille sur rendez-vous, au cœur de Luxembourg-Ville.</p></div>
<div class="c-grid">
  <div>
    <div class="c-info">
  ...
  <figure style="margin:0"><div class="c-frame"><img src="assets/ac-contact.jpg" alt="Boutique Art'Cadres Luxembourg" loading="lazy"></div></figure>
</div>
</div></section>'''
...
<div class="cfg-inner">
  ...
  <div class="cfg-stage">
    <iframe class="cfg-frame" src="{CFG_URL}" title="Configurateur d'encadrement sur mesure" loading="lazy" allow="clipboard-write; fullscreen" referrerpolicy="strict-origin-when-cross-origin"></iframe>
  </div>
</div>
</section>'''
